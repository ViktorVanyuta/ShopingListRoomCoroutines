...
import com.sakhalinec.shopinglistroomcoroutines.databinding.FragmentShopItemBinding
...
/* при клике на кнопку сохранить, вызывается из вьюмодели метод editShopItem и в него
        ...
        binding.saveBtn.setOnClickListener {
            shopItemViewModel.editShopItem(binding.editTextName.text?.toString(),
...
/* при клике на кнопку из вьюмодели вызывается метод addShopItem и
        ...
        binding.saveBtn.setOnClickListener {
            shopItemViewModel.addShopItem(binding.editTextName.text?.toString(),
                binding.editTextCount.text?.toString())
        }
    }
